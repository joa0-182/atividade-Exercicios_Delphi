object frmMesAno: TfrmMesAno
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = '3'#176' M'#234's do Ano'
  ClientHeight = 473
  ClientWidth = 486
  Color = clBtnFace
  ...
  object Label2: TLabel
    ...
    Width = 203
    Height = 19
    Caption = 'Coloque o N'#250'mero do M'#234's'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -16
    Font.Name = 'Arial'
  ...
  object edtResultado: TEdit
    ...
    Width = 120
    Height = 32
    Hint = 'Resultado do n'#250'mero do m'#234's'
    Alignment = taCenter
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -21
