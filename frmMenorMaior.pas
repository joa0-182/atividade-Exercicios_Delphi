...
begin
      Application.MessageBox('Escreva um algoritmo que receba 10 números e mostre qual é a média, o maior e o menor valor deste grupo. Dica: usar a função inputQuery().' , '5° Exercício');
end;
